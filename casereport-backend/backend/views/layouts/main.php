...
<!--                                <li><a href="#"><i class="fa fa-cog"></i> 账户设置</a></li>-->
                                <li><a href="<?=Url::to(['site/logout'])?>" data-method="post" ><i class="fa fa-sign-out"></i> Logout</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
        ...
        <div class="leftpanelinner">
            ...
            <div class="media leftpanel-profile">
                ...
                <div class="media-body">
                    <h4 class="media-heading"><?=Yii::$app->user->identity->username?><a data-toggle="collapse" data-target="#loguserinfo" class="pull-right">
